...
\begin{frame}
  ...
  \begin{block}{Commands To Change}
    \texttt{
      \begin{itemize}
      \item \textbackslash{}title[\alert{short title}]\{\alert{long title}\}
      \item \textbackslash{}subtitle[\alert{short subtitle}]\{\alert{long subtitle}\}
      \item \textbackslash{}author[\alert{short name}]\{\alert{long name}\}
      \item \textbackslash{}date[\alert{short date}]\{\alert{long date}\}
      \item \textbackslash{}institution[\alert{short name}]\{\alert{long name}\}
      \end{itemize}
    }
  \end{block}
...
\begin{frame}
  ...
  \begin{itemize}
  \item The \lstinline{[plain]} option for the frame environment causes the headlines, footlines, and sidebars to be suppressed. This can be useful for showing large pictures.
  \item If you already have a \LaTeX{} document, you can simply wrap \lstinline{\begin{frame}} and \lstinline{\end{frame}} commands around the information you want to present.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item Each call to the \lstinline{\section{section name}}, \lstinline{\subsection{subsection name}}, or \lstinline{\subsubsection{sub-subsection name}} command:
    \begin{itemize}
    ...
    \end{itemize}
  \item Another version of the command, \lstinline{\subsection*{section name}}, only adds an entry in the navigation bars, \textit{not} the table of contents.
  \end{itemize}
